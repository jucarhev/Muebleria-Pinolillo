...
<div class="panel panel-default">
	...
	<div class="panel-body comprasUser">
		<table class="table table-striped table-condensed table-hover">
			...
			<?php echo $obj->paginarListadoRegistros('pedido',$data=array('id','status','fechainicio'),"where status='pendiente'",$funciones_JS=array('eliminarpedido','editarpedido','verpedido',3),'true',0,100); ?>
		</table>
	</div>
