<ul class="nav nav-tabs">
	<li><a href="#" title=""  onclick="catalogo(1);return false">Salas</a></li>
	<li><a href="#" title=""  onclick="catalogo(2);return false">Comedores</a></li>
	<li role="presentation" class="active"><a href="#" title=""  onclick="catalogo(3);return false">Recamaras</a></li>
