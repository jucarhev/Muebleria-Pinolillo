<ul class="nav nav-tabs">
	...
	<li role="presentation" class="active"><a href="#" title=""  onclick="carga_contenido(1);return false">Salas</a></li>
	<li><a href="#" title=""  onclick="carga_contenido(2);return false">Comedores</a></li>
	...
	<div class="col-md-4">
		...
		<div class="text-justify">
			...
			<div class="btn-group btn-group-justified">
				...
				<div class="btn-group">
					<button type="button" class="btn btn-success" data-toggle='modal' data-target='#detalles_mueble'>Detalles <span class="glyphicon glyphicon-list-alt"></span></button>
				</div>
			</div>
		</div>
	</div>
